...
*/
client.users.get("566943314884952095").send("Это сообщение было сгенерировано твоим послушным котёнком перед тем как идти спать :3 \n Солнышко, если я не напишу, что проснулся в промежутке 19:00-19:20, то разбуди меня, пожалуйста 😚 \n Твой любящий муж :3")
});

    client.user.setActivity('dragon nest mobile SEA',{
  type: "STREAMING",
